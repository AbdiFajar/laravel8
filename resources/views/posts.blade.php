...
<div class="container">
   <div class="row">
      ...
      <div class="card">
         <div class="potition-absolute bg-dark px-3 py-2 text-white"><a href="/categories/{{$post->category->slug}}" class="text-white text-decoration-none">{{$post->category->name}}</a></div>
